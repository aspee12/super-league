...
import { Trophy, HandHeart, RectangleVertical } from 'lucide-react';
...
export function StatsView() {
  ...
  return (
    <div className="flex-1 min-h-0 flex flex-col px-4 py-4 md:px-8 md:py-6 md:block">
      {/* Mobile: Horizontal tabs (Figma mobile view) */}
      ...
      <div className="flex flex-col md:flex-row gap-4 md:gap-6 flex-1 min-h-0">
        ...
        {/* Stat card: header + list (shared mobile/desktop) */}
                ...
                >
                  ...
                  <div className="text-right shrink-0">
                    <div className="text-[20px] md:text-[24px] font-bold leading-[30px] md:leading-[36px] text-[#201f1e] tabular-nums">
                      {Number(stat[activeConfig.valueKey] ?? 0)}
                    </div>
